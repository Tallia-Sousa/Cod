const recuperarToken = () => {
    ...
    const carregarCursos = (data) => {
        const cursosContainer = document.getElementById('cursos-container');
        cursosContainer.innerHTML = ''; // Limpar o conteúdo existente
    ...
    const cursoFrontend = () => {
        fetch(`https://simple-porter-production.up.railway.app/cursos/frontend`, {
            headers: {
        ...
        .finally(() => {
            ...
            setTimeout(cursoFrontend, 3600000);
        });
    };
...
// Chamar a função de recuperarToken
recuperarToken();
